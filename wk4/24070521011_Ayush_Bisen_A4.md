...
1. Experiment Title: Use Function Types, Scope and Closures; Apply Try-Catch; Build a Palindrome Checker
...
4. Output:
<img width="1918" height="865" alt="image" src="https://github.com/user-attachments/assets/ea22b0c0-d283-40ed-b000-073f5fcd6cf7" />


5. Case Study Title: Vehicle Registration Number Validation Webpage using Functions, Scope, and Try-Catch

6. Case Study Program Code:### `vehicle.css`
```css
body {
...
```
7. Output:
<img width="1918" height="945" alt="image" src="https://github.com/user-attachments/assets/7c37bb70-bff2-47dc-bbb0-5f26f02dd400" />
